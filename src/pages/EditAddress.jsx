...
import { createAddress, editAddress, getAddresses, getSingleAddress } from "../slices/addressSlice";
...
const EditAddress = () => {
  ...
  const address = useSelector((state) => state.address.getSingleAddress.address)

  useEffect(() => {
    dispatch(getSingleAddress(addressID))
}, [addressID]);
  ...
  const handleEditAddress = async() => {
    try {
        await dispatch(editAddress({data: formik.values, id: addressID})).unwrap()
        dispatch(showSnackbar({ message: "Address updated successfully." }))
        navigate("/profile")
    } catch (error) {
